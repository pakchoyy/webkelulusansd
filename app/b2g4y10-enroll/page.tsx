        ...
        <div className="mt-6 pt-4 border-t border-gray-100 text-center space-y-4">
          ...
          <div className="flex flex-col items-center gap-4">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white text-sm font-bold px-4 py-2 rounded-xl transition-colors w-full"
            >
