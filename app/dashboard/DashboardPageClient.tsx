...
export default function DashboardPageClient({ school, total, lulus, tdkLulus, countdownDate }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Support Section */}
      <div className="mt-8 mb-6 text-center space-y-4">
        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Butuh bantuan?</p>
        <div className="flex flex-col items-center gap-4">
          <a 
            href="https://wa.me/6289530713597?text=Halo%20Pak%20Choy%2C%20saya%20butuh%20bantuan%20terkait%20dashboard%20kelulusan%20SD"
            target="_blank"
      ...
      {/* Footer */}
      <footer className="pt-8 pb-10 text-center border-t border-gray-100">
        <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">Portal Kelulusan SD</p>
        <p className="text-[10px] text-gray-400 font-bold">
          © 2026 Bantu Guru Yuk by <a href="https://tiktok.com/@pak.choyy" target="_blank" className="underline hover:text-blue-600 font-black">pak.choyy</a> • v 26.5.4
        </p>
      </footer>
